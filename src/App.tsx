...
function App() {
  ...
  return (
    <Container className="fluid bg-dark m-0">
      <Row><Col className="d-none d-md-flex"><MyHeader /></Col>
        <Col xs={12} md={9}>
          <Row>
            <Row className="d-none d-md-flex align-items-center pt-2"><BigPlayer /></Row>
            <Col className="p-0 d-md-none"><MyNavbar /></Col>
          </Row>
          <Row><h1 className="fw-bold text-light pt-3">Novità</h1>
            <hr className="ms-3 text-secondary"></hr>
          ...
          <Row className=" d-flex justify-content-center d-md-none"><MusicPlayer /></Row>
        </Col>
      </Row>
    </Container>
  )
